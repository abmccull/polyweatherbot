    ...
    try:
        ...
        snapshot = {
            ...
            "params": {
                ...
                "shadow_expansion_enabled": config.shadow_expansion_enabled,
                "shadow_min_confidence": config.shadow_min_confidence,
                "shadow_min_price": config.shadow_min_price,
                "shadow_max_price": config.shadow_max_price,
                "shadow_max_bet_usd": config.shadow_max_bet_usd,
